...
export function FotoProfilInput({ currentFoto }: Props) {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
          <div className="flex max-h-[90vh] w-full max-w-lg flex-col gap-4 rounded-xl bg-background p-6 shadow-xl">
            <div>
              <h2 className="text-base font-semibold text-foreground">Crop Foto Profil</h2>
              <p className="mt-0.5 text-xs text-muted-foreground">
                Seret dan resize lingkaran untuk memilih area foto.
              </p>
            </div>
